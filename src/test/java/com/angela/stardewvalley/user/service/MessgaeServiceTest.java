...
class MessgaeServiceTest {
    ...
    void findAllMessageGroupByUserId() {
        //打印所有消息组的每个字段
        messgaeService.findAllMessageGroupByUserId(1L).forEach(messageGroup -> {
    ...
    void findAllMessgaeDetailByMessageId() {
        //打印所有消息详情
        messgaeService.findAllMessgaeDetailByMessageId(1L).forEach(messageDetail -> {
